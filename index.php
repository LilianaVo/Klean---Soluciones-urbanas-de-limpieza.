...
<body id="inicio"> <nav class="nav">
    ...
    <header class="hero">
        <div class="container">
            ...
            <h1 id="tituloPrincipal" style="text-shadow: 2px 2px 4px rgba(0,0,0,0.5);">Llevamos la limpieza a un nuevo nivel</h1>
    ...
    <section id="servicios" class="section-padding">
        <div class="container">
            ...
            <div class="grid-4">
                <article class="card">
                    <img src="./images/residential_pro.jpg" class="card-img" alt="Servicio Residencial" onerror="this.src='https://via.placeholder.com/400x200'">
                    <div class="card-body">
                ...
                <article class="card">
                    <img src="./images/corporate_pro.jpg" class="card-img" alt="Servicio Corporativo" onerror="this.src='https://via.placeholder.com/400x200'">
                    <div class="card-body">
                ...
                <article class="card">
                    <img src="./images/cleaning.jpg" class="card-img" alt="Limpieza Post-Obra" onerror="this.src='https://via.placeholder.com/400x200'">
                    <div class="card-body">
                ...
                <article class="card">
                    <img src="./images/tech_clean.jpg" class="card-img" alt="Tecnología de Limpieza" onerror="this.src='https://via.placeholder.com/400x200'">
                    <div class="card-body">
                ...
                <article class="card">
                    <img src="./images/eco_supplies.jpg" class="card-img" alt="Insumos ecológicos" onerror="this.src='https://via.placeholder.com/400x200'">
                    <div class="card-body">
                ...
                <article class="card">
                    <img src="./images/security_team.jpg" class="card-img" alt="Seguridad y confianza" onerror="this.src='https://via.placeholder.com/400x200'">
                    <div class="card-body">
    ...
    <video width="100%" height="auto" controls>
        <source src="/images/Klean_Video_Promocional_Servicios_de_Limpieza.mp4" type="video/mp4">
    ...
    <footer class="footer">
        <div class="container">
            ...
            <div style="text-align: center; padding-top: 30px; border-top: 1px solid rgba(255,255,255,0.1); color: #64748b; font-size: 0.85rem; display: flex; justify-content: space-between; align-items: center;">
                ...
                <a href="#inicio" style="color: #94a3b8; text-decoration: none;">⬆ Volver arriba</a>
    ...
    // Función JS (Requisito de modificar aspecto)
    function cambiarEstiloJS() {
        var titulo = document.getElementById('tituloPrincipal');
        titulo.scrollIntoView({behavior: "smooth"});

        // Ajusté el texto que busca para que coincida con tu título actual
        if (titulo.innerText.includes("Llevamos la limpieza")) {
            ...
            titulo.innerHTML = "Llevamos la limpieza a un nuevo nivel";
